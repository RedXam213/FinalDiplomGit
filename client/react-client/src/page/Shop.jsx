...
3)Тут мы уже рассчитываем кол-во отображаемых страниц в баре с помощью count и limit, и создаем deviceItem через DeviceList из устройств переданных в device
*/